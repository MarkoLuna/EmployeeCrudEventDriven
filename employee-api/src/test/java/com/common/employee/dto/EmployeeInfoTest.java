...
class EmployeeInfoTest {
  ...
  void employeeFirstNameIsEmpty() {
    EmployeeInfo employeeInfo =
        new EmployeeInfo("", "J", "Luna", BASIC_DATE, BASIC_DATE, EmployeeStatus.ACTIVE);
  ...
  void employeeDateOfEmploymentIsNull() {
    EmployeeInfo employeeInfo =
        new EmployeeInfo("Gerardo", "J", "Luna", BASIC_DATE, null, EmployeeStatus.ACTIVE);
  ...
  void employeeDateOfBirthIsNull() {
    EmployeeInfo employeeInfo =
        new EmployeeInfo("Gerardo", "J", "Luna", null, BASIC_DATE, EmployeeStatus.ACTIVE);
