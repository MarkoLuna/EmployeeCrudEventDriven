...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  /**
   * Implement a handler for a {@link IamServiceException}.
   *
   * @param ex the {@link IamServiceException}
   * @return {@link ResponseEntity}
   */
  @ExceptionHandler(IamServiceException.class)
  public ResponseEntity<Object> handleIamServiceException(IamServiceException ex) {
    log.warn("handleIamServiceException", ex);
